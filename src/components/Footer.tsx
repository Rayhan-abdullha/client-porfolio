                    ...
                    <ul className="flex gap-5">
                        {
                            contactMe.socialLinks.map((item: { id: number, url: string }) => (
                                <li key={item.id} className={`${isDarkMode ? 'bg-[#2e2e2e]' : 'bg-white'} hover:text-white rounded-full p-3 cursor-pointer hover:bg-[#1BA1F2] transition duration-300 ease-in-out`}>
